...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "chapter_16_point_light", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lighting_shader = shader_create(
        "shaders/chapter_16_lighting_shader_point_light.vert",
        "shaders/chapter_16_lighting_shader_point_light.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        set_point_light_uniform(lighting_shader, point_light, "light");
        ...
        model_light_cube = glm::translate(model_light_cube, point_light.position);
        ...
        shader_set_vec3(light_cube_shader, "light_color", point_light.specular);
