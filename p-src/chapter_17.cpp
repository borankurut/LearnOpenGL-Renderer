...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "chapter_17", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lighting_shader = shader_create("shaders/chapter_17.vert", "shaders/chapter_17.frag");
