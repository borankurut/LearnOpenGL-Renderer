...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "chapter_13_view", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader light_cube_shader = shader_create(
        "shaders/chapter_12_light_cube_shader.vert", "shaders/chapter_12_light_cube_shader.frag");

    Shader lighting_shader = shader_create(
        "shaders/chapter_13_lighting_shader_view.vert",
        "shaders/chapter_13_lighting_shader_view.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat3 normal_matrix = glm::mat3(glm::transpose(glm::inverse(view * model_container)));
        ...
        shader_set_vec3(lighting_shader, "light_world_position", light_position);
        shader_set_float(lighting_shader, "specular_power", 64.0f);
