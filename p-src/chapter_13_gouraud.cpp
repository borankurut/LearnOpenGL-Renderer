...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "chapter_13_gouraud", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lighting_shader = shader_create(
        "shaders/chapter_13_lighting_shader_gouraud.vert",
        "shaders/chapter_13_lighting_shader_gouraud.frag");
