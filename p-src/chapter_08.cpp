...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "chapter_08", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader shader_program = shader_create("shaders/chapter_08.vert", "shaders/chapter_08.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader_set_mat4(shader_program, "trans", trans2);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
