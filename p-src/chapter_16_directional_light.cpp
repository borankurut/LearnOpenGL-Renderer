...
int main()
{
    ...
    GLFWwindow* window =
        glfwCreateWindow(800, 600, "chapter_16_directional_light", nullptr, nullptr);
    if (window == nullptr)
    {
    ...
    Shader lighting_shader = shader_create(
        "shaders/chapter_16_lighting_shader_directional.vert",
        "shaders/chapter_16_lighting_shader_directional.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        set_directional_light_uniform(lighting_shader, directionalLight, "light");
